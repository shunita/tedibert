...
# Init environment
RUN pip install pandas ipython jupyter pytorch-lightning optuna flask bokeh panel pathos tensorboard tensorflow datetime wandb sentencepiece==0.1.91 transformers sklearn
